<template>
  <div>
      ...
      <div class="flex-shrink-0 px-4 py-3 bg-gray-700 lg:w-64 lg:bg-gray-800">
        ...
        <button class="hidden sm:flex sm:items-center sm:w-full">
          <img
            ...
            alt
          />
          <span class="hidden lg:inline ml-4 mr-2 text-sm font-medium text-white">Monica White</span>
    ...
    <div class="flex-1 flex overflow-hidden">
      <div
        :class="isOpen ? 'translate-x-0 ease-out transition-slow' : '-translate-x-full ease-in transition-medium'"
      ...
      >
        <div class="absolute top-0 left-0 pl-4 pt-3 sm:hidden">
          <button ref="closeButton" @click="close" class="block text-gray-600 hover:text-gray-800">
            <svg class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
              <path
        ...
        <nav class="mt-16 sm:mt-0">
          <div class="px-6 sm:hidden">
            <a href="#" class="block py-1 text-sm font-medium text-gray-900">Mailbox</a>
            <a href="#" class="mt-2 block py-1 text-sm font-medium text-gray-900">Customers</a>
            <a href="#" class="mt-2 block py-1 text-sm font-medium text-gray-900">Reporting</a>
            <a href="#" class="mt-2 block py-1 text-sm font-medium text-gray-900">Manage</a>
          </div>
          <div class="mt-8 px-6">
          ...
          <div class="mt-8 p-6 border-t sm:hidden">
            <div class="flex items-center">
              <img
                ...
                alt
              />
              <span class="ml-4 mr-2 text-sm font-medium text-gray-800">Monica White</span>
            </div>
            <div class="mt-4">
      ...
      <main class="flex-1 flex bg-gray-200"></main>
    </div>
  </div>
</template>
